...
> knowledge for roles at , EPEX SPOT, ENTSO‑E, or similar.
...
Cor a single zone with supply curve S(q) and demand curve D(q).  At equilibrium
...
## 4. The Euphemia Algorithm — N‑SIDE's Implementation
...
Loop flows are the primary reason FBMC exists.  Cor three zones A, B, C in a
triangle:
