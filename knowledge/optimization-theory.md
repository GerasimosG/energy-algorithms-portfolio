...
The mathematical foundation behind every optimization in this repo. When an interviewer asks "what solver did you use and why?", you need to be able to explain not just which one, but what's happening inside.
